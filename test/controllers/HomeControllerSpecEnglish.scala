...
class HomeControllerSpecEnglish extends PlaySpec with BeforeAndAfter with BeforeAndAfterAll with GuiceOneAppPerSuite with DefaultAwaitTimeout with Injecting {
  ...
  val paraphrase2 = "There is a pet and a animal."
  ...
  "The specification1" should {
    "returns an appropriate response" in {
      ...
      val paraphraseKnowledge1 = getKnowledge2(lang=lang, sentence=paraphrase1, List((referencePara1Ok, imageBoxInfoPara1Ok)), transversalState)
